...
namespace WebAPI
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<AppDatabaseSettings>(
                _configuration.GetSection(nameof(AppDatabaseSettings)));

            services.AddSingleton<IAppDatabaseSettings>(sp =>
                sp.GetRequiredService<IOptions<AppDatabaseSettings>>().Value);
